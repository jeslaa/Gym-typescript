...
const benefitsComponent: Array<BenefitType> = [
    {
        icon: <HomeModernIcon className="h-6 w-6" />,
        title: "State of the Art Facilities",
        description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur ratione odio animi officia porro quidem odit, delectus explicabo, vel consectetur excepturi necessitatibus maxime iusto atque omnis distinctio obcaecati facere. Non.'
    },
    {
...
const Benefits = ({setSelectedPage}: Props) => {
  return <section id="benefits" className="mx-auto min-h-full w-5/6 py-20">
    ...
    {/* HEADER */}
        ...
        variants={container}>
            {benefitsComponent.map((benefit: BenefitType) => (
                <BenefitComponent
                key={benefit.title}
                icon={benefit.icon}
                title={benefit.title}
            ...
            <div>
                ...
                <div className="relative">
                    <div className="before:absolute before:-top-20 before:-left-20 before:z-[-1] before:content-abstractwaves">
                        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} transition={{ delay:0.1, duration: 0.5 }}
                        variants={{ hidden: { opacity: 0, x:50 }, visible: { opacity: 1, x:0 }}}>
                            <HText>
                ...
                <div className="relative mt-16">
                    <div className="before:absolute before:-botom-20 before:right-40 before:z-[1] before:content-sparkles">
